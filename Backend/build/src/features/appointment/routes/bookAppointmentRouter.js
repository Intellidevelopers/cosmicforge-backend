...
const bookAppointmentController_1 = require("../controller/bookAppointmentController");
const bookAppointmentRouter = express_1.default.Router();
/**
 * @swagger
 ...
 *
 */
bookAppointmentRouter.post('/patient/appointment/book', userAuthenticationMiddleware_1.default, bookAppointmentController_1.bookAppointment);
bookAppointmentRouter.get('/medics/appointments', userAuthenticationMiddleware_1.default, bookAppointmentController_1.getSpecificDoctorAppointments);
